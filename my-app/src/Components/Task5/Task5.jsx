...
function FifthTask({ startPerformance, performance, stage, actorsList, chooseActor }) {
  ...
  return (
    <div>
      ...
      <div>
        ...
        {performance && <Stage stage={stage} actorsList={actorsList} chooseActor={chooseActor}></Stage>}
      </div>
